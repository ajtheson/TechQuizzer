        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    ...
                    <form method="get" action="subject-lesson" class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${lesson.status==true}">
                                            <a href="toggle-lesson-status-admin?action=changeStatusLesson&id=${lesson.id}&status=0"
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <c:set var="urlBase" value="subject-lesson?subject=${subject}&lessonType=${lessonType}&search=${search}&sortField=${sortField}&sortOrder=${sortOrder}&pageSize=${pageSize}" />
