...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="bi bi-ui-checks"></i> Edit Setting</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <form action="edit-setting" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="type" name="type" required>
                                ...
                                <option value="Test Types" ${type == 'Test Types' ? 'selected="selected"' : ''}>Test Types</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="value" type="text" value="${empty value ? '' : value}" name="value" required>
                        </div>
                        <div class="mb-3">
                            <label class="col-form-label" for="order">Order</label>
                            <input class="form-control" id="order" type="number" value="${empty order ? '' : order}" name="order" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleTextarea">Description</label>
                            <textarea class="form-control" id="exampleTextarea" rows="3" name="description" required>${empty description ? '' : description}</textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="exampleSelect1" name="status" required>
                                ...
                                <option value="activate" ${status == 'activate' ? 'selected="selected"' : ''}>Activate</option>
                                <option value="deactivate" ${status == 'deactivate'? 'selected="selected"' : '' }>Deactivate</option>
                            </select>
                        </div>
