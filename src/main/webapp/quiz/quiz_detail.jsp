                    ...
                    <form action="detail" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="level" name="level" required>
                                <option value="" disabled <c:if test="${empty selectedLevelId}">selected</c:if>>Select
                                    level
                                </option>
                                <c:forEach var="level" items="${requestScope.levels}">
                                    <option value="${level.getId()}"
                                            <c:if test="${level.getId() == selectedLevelId}">selected</c:if>>
                                            ${level.getName()}
                                    </option>
                                </c:forEach>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="numberOfQuestions"
                                   value="${quiz.quizSetting.numberOfQuestions}" min="1" readonly>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Duration (minutes)</label>
                            <input type="number" class="form-control" name="duration"
                                   value="${(quiz.duration / 60).intValue()}" min="1" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Pass Rate (%)</label>
                            <input type="number" class="form-control" name="passRate" value="${quiz.passRate}" min="0"
                                   max="100" required>
                        </div>
                    ...
                    <div class="tile-body ${hasAttempt ? 'disabled-overlay' : ''}">
                        ...
                        <form action="quiz-setting" method="post" id="quizSettingForm">
                                    ...
                                    <div class="mb-2 row">
                                        <div class="col-8">
                                            <select class="form-control" name="questionGroups">
                                                <option value="" disabled selected>Please select question type first
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-2">
                                            <input class="form-control" type="number" name="questionCounts"
                                                   placeholder="#question" min="1" required>
                                        </div>
                                        <div class="col-2 d-grid">
                                            <button class="btn btn-outline-success" type="button"
                                                    onclick="addQuestionGroup()">Add
                                            </button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="btn-group-container">
                                <button type="submit" class="btn btn-primary" id="saveSettingsBtn">Save Settings
                                </button>
