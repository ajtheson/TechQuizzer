...
<div class="d-flex flex-column" style="min-height: 100vh;">
    ...
    <div class="flex-grow-1 d-flex flex-column" style="padding: 20px 40px">
        ...
        <div class="d-flex justify-content-end gap-3 mt-auto">
            <button id="peekBtn" class="btn ${requestScope.questionAttempts[0].examAttempt.type.equalsIgnoreCase("Practice") ? '' : 'invisible'}"
                    style="border: #ccc solid 2px; color: #4c4c4c">
                Peek at answer
            </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body p-4">
                <h5 class="mb-3 fw-bold">Exit Exam?</h5>
                <p>
                    You have not answered any questions. By clicking on the [Exit Exam] button below,
                ...
                <div class="d-flex justify-content-end gap-3 mt-4">
                    ...
                    <button id="exitBtn" class="btn" style="width: 150px; border: #64c281 solid 2px; color: #64c281">
                        Exit Exam
                    </button>
                </div>
            </div>
...
<div class="modal fade" id="popupReviewProgress" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-body p-4">
                <div class="d-flex justify-content-between">
                    <h5 class="mb-3 fw-bold">Review Progress</h5>
